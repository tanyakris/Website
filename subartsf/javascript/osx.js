...
jQuery(function ($) {
	var OSX = {
		container: null,
		init: function () {
			$("input.osx5, a.osx5").click(function (e) {
				e.preventDefault();	
		...
		open: function (d) {
			...
			self.container = d.container[0];
			d.overlay.fadeIn('slow', function () {
				$("#osx-modal-content5", self.container).show();
				var title = $("#osx-modal-title5", self.container);
				title.show();
				d.container.slideDown('slow', function () {
					setTimeout(function () {
						var h = $("#osx-modal-data5", self.container).height()
							+ title.height()
							+ 20; // padding
						d.container.animate(
							{height: h}, 
							200,
							function () {
								$("div.close5", self.container).show();
								$("#osx-modal-data5", self.container).show();
							}
						);
					}, 300);
				});
...
jQuery(function ($) {
	var OSX = {
		container: null,
		init: function () {
			$("input.osx6, a.osx6").click(function (e) {
				e.preventDefault();	
		...
		open: function (d) {
			...
			self.container = d.container[0];
			d.overlay.fadeIn('slow', function () {
				$("#osx-modal-content6", self.container).show();
				var title = $("#osx-modal-title6", self.container);
				title.show();
				d.container.slideDown('slow', function () {
					setTimeout(function () {
						var h = $("#osx-modal-data6", self.container).height()
							+ title.height()
							+ 20; // padding
						d.container.animate(
							{height: h}, 
							200,
							function () {
								$("div.close6", self.container).show();
								$("#osx-modal-data6", self.container).show();
							}
						);
					}, 300);
				});
